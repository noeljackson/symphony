defmodule SymphonyElixir.Orchestrator do
    ...
    running =
      ...
      |> Enum.map(fn {issue_id, metadata} ->
        %{
          ...
          agent_runner_pid: metadata.agent_runner_pid,
  ...
  defp integrate_codex_update(running_entry, %{event: event, timestamp: timestamp} = update) do
    ...
    agent_runner_pid = Map.get(running_entry, :agent_runner_pid)
...

    {
      Map.merge(running_entry, %{
        ...
        agent_runner_pid: agent_runner_pid_for_update(agent_runner_pid, update),
  ...
  defp agent_runner_pid_for_update(_existing, %{agent_runner_pid: pid})
       when is_binary(pid),
       do: pid
  ...
  defp agent_runner_pid_for_update(_existing, %{agent_runner_pid: pid}) when is_list(pid),
    do: to_string(pid)

  defp agent_runner_pid_for_update(existing, _update), do: existing
